  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex flex-col md:flex-row justify-center items-center flex-1 px-8 py-12 gap-12 ">
        ...
        <div className="w-1/2 flex justify-center items-center bg-[#E3F6F5] min-h-[1000px]">
          <Image
            src="/iphone14-removebg-preview.png" 
            alt="Shopping Cart"
            width={500}
            height={500}
        ...
        <div className="w-1/2 flex flex-col justify-center px-20 min-h-[1000px]">
