...
<div>
  ...
  <div className=" gap-6  flex flex-col sm:flex-row items-center sm:items-start">
    ...
    <div className="flex flex-col gap-2">
      <a
        href="#"
        className="flex items-center gap-2 border border-gray-500 rounded-xl px-3 py-2 bg-black-transparent text-white text-sm hover:bg-gray-900 transition w-41"
      >
        <img src="/play.png" className="w-8 h-auto" />
        <span className="flex flex-col leading-tight">
          <span className="text-[10px] uppercase">Get it on</span>
          <span className="font-bold text-1xl">Google Play</span>
        </span>
      </a>
      <a
        href="#"
        className="flex items-center gap-2 border border-gray-500 rounded-lg px-3 py-2 bg-black-transparent text-white text-sm hover:bg-gray-900 transition w-41"
      >
        <img src="/apple.png" className="w-8 h-auto bg-white p-1 rounded" />
        <span className="flex flex-col leading-tight">
          <span className="text-[10px]">Download on the</span>
          <span className="font-bold text-1xl">App Store</span>
        </span>
      </a>
    </div>
  </div>
