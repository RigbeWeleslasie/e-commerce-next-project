    ...
    <section className="py-10 bg-gray-100 w-full">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row gap-6 w-full" >
          ...
          <div className="w-full md:w-1/2 text-white p-6 rounded-lg flex flex-col items-center">
            <div className="bg-black p-4 rounded-lg flex flex-col md:flex-row items-center gap-4">
                 <div className='py-4'>
                <h2 className="text-2xl font-semibold mb-2">Women's Collections</h2>
                <p className="mb-4 text-center">Featured woman collections that give you another vibe.</p>
                <p className="text-2xl font-bold">Shop Now</p>
                </div>
              ...
              <div className="flex  items-center space-y-6">
                <div className="bg-black p-4 rounded-lg flex flex-col md:flex-row items-center gap-4">
                  ...
                  height={200}
                    className="mb-4"
                  />
                  <h2 className=" text-2xl-white font-semibold mb-2">Speakers</h2>
